...
router.get('/',
    ...
    asyncHandler(async (req, res) => {
        console.log('>>> /api/projects route handler called');
        throw new Error('Test error: Is this visible in the console?');
        try {
            ...
            console.error('Error fetching projects:', error, error && error.stack);
